        ...
        <div className="container flex h-14 md:h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              <span className="text-base md:text-xl font-bold truncate max-w-[100px] sm:max-w-none">{platformName}</span>
              <span className="rounded-md bg-primary px-1.5 py-0.5 md:px-2 md:py-1 text-[10px] md:text-xs font-semibold text-white whitespace-nowrap">
                SUPER ADMIN
              </span>
            </div>
          </div>
