...
export function ExpenseCategoryForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Xarajat turi muvaffaqiyatli yaratildi!')
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Xarajat turining nomi (masalan: Soliq, Maosh, Kommunal, Remont)
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          Muddat uchun maksimal xarajat miqdori
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Limit qaysi muddat uchun (kunlik, haftalik, oylik yoki yillik)
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          UI'da xarajat turini ajratish uchun
        </p>
      </div>
