...
import { updateBuildingSchema, type BuildingFormData } from '@/lib/validations/dormitory'
import { updateBuilding } from '@/app/actions/dormitory'
...
export function BuildingEditForm({ building }: BuildingEditFormProps) {
  ...
  const form = useForm<BuildingFormData>({
    ...
    defaultValues: {
      ...
      gender: building.gender ? building.gender : 'MIXED',
  ...
  async function onSubmit(data: BuildingFormData) {
    ...
    if (result.success) {
      toast({
        ...
        description: 'Bino ma\'lumotlari yangilandi',
      })
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Bino haqida asosiy ma'lumotlarni o'zgartiring
            </CardDescription>
          </CardHeader>
